...
type BookUsecase interface {
	...
	CreateBook(ctx context.Context, u user2.CreateBookReq, userId int) error
	EditBook(ctx context.Context, u user2.CreateBookReq, userId int, id int) error
...
func (uc *bookUsecase) GetBooks(ctx context.Context, userId int) (books []model.Book, err error) {
...
func (uc *bookUsecase) GetBook(ctx context.Context, userId int, id int) (book *model.Book, err error) {
...
func (uc *bookUsecase) CreateBook(ctx context.Context, u user2.CreateBookReq, userId int) (err error) {
...
func (uc *bookUsecase) EditBook(ctx context.Context, u user2.CreateBookReq, userId int, id int) (err error) {
